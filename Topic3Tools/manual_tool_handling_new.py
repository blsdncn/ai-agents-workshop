...
if __name__ == "__main__":
    ...
    print("\n" + "=" * 60)
    print("TEST 4: Calling calculator")
    print("=" * 60)
    run_agent("Calculate 69 + 67")

    print("\n" + "=" * 60)
    print("TEST 4: Combining different tool calls")
    print("=" * 60)
    run_agent(
        "Is it colder in San Francisco or in London?, also calculate by how much."
    )
